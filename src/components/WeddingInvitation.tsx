...
const WeddingInvitation: React.FC<WeddingInvitationProps> = ({ client = 'load' }) => {
  ...
  // Framer-motion variants for better animation
  ...
  return (
    <>
      {/* Opening Page with framer-motion */}
      <AnimatePresence>
        {!isOpened && (
          <motion.div
      ...
      <AnimatePresence>
        {showMainContent && (
          ...
          >
            ...
            {/* Main Card with framer-motion, improved animation */}
            <motion.div
              className="card"
              variants={fadeUp}
              initial="hidden"
            ...
            <section className="gift-section animate__animated animate__fadeIn " style={{
              ...
              <section className=" animate__animated animate__fadeInUp " style={{
                textAlign: 'center',
                position: 'relative',
              }}>
                <div className="love-title animate__animated animate__bounceIn " style={{
                  marginBottom: '2rem',
                  marginTop: '2rem',
                  position: 'relative'
                }}>
                ...
                <div className="love-story animate__animated animate__zoomIn " style={{
                  marginBottom: '2rem',
                  padding: '1.5rem',
                  background: 'linear-gradient(135deg, rgba(165, 124, 197, 0.1), rgba(212, 181, 224, 0.1))',
                  borderRadius: '1.5rem',
